...
for leverage_factor in leverage_factors:
    ...
    trade_logs, final_values, interest_costs_total, transaction_costs_total = rolling_window_train_predict(data, 2013, 2023, 12, 6, leverage_factor=leverage_factor)  # 12 months training, 6 months testing

...
# Load data from the second JSON file (gbt_pnl_v_leverage.json)
with open('nn_pnl_v_leverage.json', 'r') as file3:
    nn_data = json.load(file3)
...
pnl_distribution_leverage_4_nn = nn_data.get('Leverage4', {}).get('PnL Distribution', [])
...
cumulative_pnl_nn = calculate_cumulative_pnl(pnl_distribution_leverage_4_nn)
...
periods = ['2013-01-30', '2013-06-30', '2014-01-30', '2014-06-30',\
           ...
           '2019-01-30', '2019-06-30', '2020-01-30', '2020-06-30',\
...
data = {
    ...
    'Cumulative_PNL_NN': cumulative_pnl_nn
}
...
plt.plot(data_df['Period'], data_df['Cumulative_PNL_NN'], label='NN PnL')
...
plt.savefig('pnl_chartv4.png', dpi=300, bbox_inches='tight')  # Save the plot as PNG

...
class BaseModel:
    ...
    def detect_fourier_signals(self):
        ...
        self.data['FourierSignalBuy'] = self.data['DaysSinceTrough'].isin(
            dominant_period_lengths)
        self.data['FourierSignalSell'] = self.data['DaysSincePeak'].isin(
            dominant_period_lengths)
    ...
    def detect_peaks_and_troughs(self):
        ...
        labels.loc[peaks, 'Label'] = 'Buy'
        labels.loc[troughs, 'Label'] = 'Sell'
